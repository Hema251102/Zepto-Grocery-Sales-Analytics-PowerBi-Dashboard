...
Customer Ratings: 3.92 (average)

Top-Performing Tier: Tier 3 with $472K in sales

Category Performance: Fruits & Snacks lead the sales
...
Ensured data consistency and accuracy across 10K+ records.

2️⃣ Data Analysis
Explored key metrics such as total sales, item-wise revenue, and customer ratings.

Performed tier-wise and category-wise analysis to identify sales trends.

3️⃣ Dashboard Development
Designed an interactive Power BI dashboard with bar charts, pie charts, and KPIs.

Created calculated columns to derive additional insights.
...
Enhances customer experience by analyzing feedback patterns.**
